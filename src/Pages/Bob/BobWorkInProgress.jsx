...
function BobWorkInProgress() {
  return (
    <GreenRectangleContainer>
      ...
      <h1 className="text-3xl font-bold text-green-500 mb-2">Work in Progress</h1>
      <p className="text-lg text-green-500 font-semibold text-center px-8">This page is under construction. Please check back soon!</p>
    </GreenRectangleContainer>
  );
}
